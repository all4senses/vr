...
<?php endif; ?>
  ...
  <div class="main-content"  xmlns:v="http://rdf.data-vocabulary.org/#" typeof="v:Review">
        ...
        <div class="content"<?php print $content_attributes; ?>>
          ...
          <div class="vr_votes">
            <?php echo '<div class="caption"><span>' , t('User\'s Rating') , ':</span> <span property="v:rating">' , (empty($node->field_r_rating_overall['und'][0]['value']) ? $node->field_r_rating_overall[0]['value'] : $node->field_r_rating_overall['und'][0]['value']), '</span>' /* render($content['vr_rating_overall'])*/ , '<div class="bottom-clear"></div></div>' , render($content['vr_ratings']); ?>
            <div class="rate-other">
              ...
              <?php endif; ?>
              <div class="text"><?php echo '<div class="title">' . t('Recommend') . ': </div><div class="data">' . $node->vr_recommend . '</div>'?></div>
            </div>
          </div>
          ...
          <div class="links">
            ...
            /*
              ...
              echo '<div class="rlinks">';
                      ...
                      if ($page || $full_title) {
                        echo ( !$provider_name ? '' : '<a href="' . url('node/' . $node->field_ref_provider['und'][0]['target_id']) . '">View All <span class="review-provider">' . $provider_name . '</span> Reviews</a> <span class="delim">|</span>')
